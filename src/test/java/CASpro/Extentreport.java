...
public class Extentreport implements ITestListener{
	...
	public void onStart(ITestContext testContext) {
		...
		sparkReporter.config().setDocumentTitle("Cognizant header Automation Report"); 			// Specifies the title of report
		sparkReporter.config().setReportName("Cognizant header Testing"); 				// Specifies the name of the report
		sparkReporter.config().setTheme(Theme.DARK);
		extent = new ExtentReports();
		extent.attachReporter(sparkReporter);
		extent.setSystemInfo("Application", "Automation Practice");
